...
export const assetManifest = {
  ...
  'vehicle.traffic.sport-coupe': {
    type: 'model',
    url: '/assets/vehicles/quaternius-cars/sport-coupe.glb',
    attribution: {
      title: 'Sports Car (SportsCar2)',
      creator: 'Quaternius',
      sourceUrl: 'https://poly.pizza/m/1mkmFkAz5v',
      license: 'CC0 1.0 Universal',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
    },
    metadata: {
  ...
  'vehicle.traffic.family-sedan': {
    type: 'model',
    url: '/assets/vehicles/quaternius-cars/family-sedan.glb',
    attribution: {
      title: 'Car (NormalCar1)',
      creator: 'Quaternius',
  ...
  'vehicle.traffic.taxi-sedan': {
    type: 'model',
    url: '/assets/vehicles/quaternius-cars/taxi-sedan.glb',
    attribution: {
      title: 'Taxi',
      creator: 'Quaternius',
      sourceUrl: 'https://poly.pizza/m/x43lOScTpN',
      license: 'CC0 1.0 Universal',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
    },
    metadata: {
  ...
  'vehicle.traffic.suv': {
    type: 'model',
    url: '/assets/vehicles/quaternius-cars/suv.glb',
    attribution: {
      title: 'SUV',
      creator: 'Quaternius',
  ...
  'vehicle.traffic.compact-wagon': {
    type: 'model',
    url: '/assets/vehicles/quaternius-cars/compact-wagon.glb',
    attribution: {
      title: 'Car (NormalCar2)',
      creator: 'Quaternius',
      sourceUrl: 'https://poly.pizza/m/unqqkULtRU',
      license: 'CC0 1.0 Universal',
      licenseUrl: 'https://creativecommons.org/publicdomain/zero/1.0/',
    },
    metadata: {
